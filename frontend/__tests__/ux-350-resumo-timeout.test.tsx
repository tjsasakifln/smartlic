...
describe("AC9: LLM Source Badge timeout behavior", () => {
  it("shows 'Classificando...' when llm_source is processing", () => {
  ...
  it("shows 'Classificação inteligente' when llm_source is ai", () => {
    render(<LlmSourceBadge llmSource="ai" />);
    expect(screen.getByText("Classificação inteligente")).toBeInTheDocument();
  });
