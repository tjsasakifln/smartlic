/**
 * API proxy: GET /api/pseo/top-suppliers → backend GET /v1/pseo/top-suppliers
 * Issue #1007: pSEO DataBlock — Top 5 fornecedores por volume de contratos.
...
export async function GET(request: NextRequest) {
  ...
  try {
    const resp = await fetch(
      `${BACKEND_URL}/v1/pseo/top-suppliers?${params.toString()}`,
      {
