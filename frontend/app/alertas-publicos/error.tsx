...
/**
 * SEO programmatic error boundary — /alertas-publicos/*
 */

import { useEffect } from 'react';

export default function AlertasPublicosError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[alertas-publicos/error] page render error:', error.message);
  }, [error]);
