      ...
      {!loading && result && (result.resumo?.total_oportunidades ?? 0) > 0 && (
        <div className={`mt-6 sm:mt-8 space-y-4 sm:space-y-6 ${!showGrid ? 'animate-fade-in-up' : ''}`}>
          ...
          {planInfo && planInfo.capabilities.max_requests_per_month > 0 && (planInfo.quota_used / planInfo.capabilities.max_requests_per_month) >= 0.8 && <TrialUpsellCTA variant="quota" planId={planInfo.plan_id} subscriptionStatus={planInfo.subscription_status} contextData={{ usageLabel: `${planInfo.quota_used}/${planInfo.capabilities.max_requests_per_month}`, usagePct: Math.round((planInfo.quota_used / planInfo.capabilities.max_requests_per_month) * 100) }} />}
	          <ResultsList result={result} paginatedLicitacoes={paginatedLicitacoes} totalLicitacoes={totalLicitacoes} currentPage={currentPage} pageSize={pageSize} onPageChange={setCurrentPage} onPageSizeChange={setPageSize} searchMode={searchMode} termosArray={termosArray} planInfo={planInfo} session={session} onShowUpgradeModal={onShowUpgradeModal} searchId={searchId} setorId={setorId} paywallApplied={paywallApplied} totalBeforePaywall={totalBeforePaywall} sectorName={sectorName} />
	          <ResultsList result={result} paginatedLicitacoes={paginatedLicitacoes} totalLicitacoes={totalLicitacoes} currentPage={currentPage} pageSize={pageSize} onPageChange={setCurrentPage} onPageSizeChange={setPageSize} searchMode={searchMode} termosArray={termosArray} planInfo={planInfo} session={session} onShowUpgradeModal={onShowUpgradeModal} searchId={searchId} setorId={setorId} paywallApplied={paywallApplied} totalBeforePaywall={totalBeforePaywall} sectorName={sectorName} />
	          <ResultsList result={result} paginatedLicitacoes={paginatedLicitacoes} totalLicitacoes={totalLicitacoes} currentPage={currentPage} pageSize={pageSize} onPageChange={setCurrentPage} onPageSizeChange={setPageSize} searchMode={searchMode} termosArray={termosArray} planInfo={planInfo} session={session} onShowUpgradeModal={onShowUpgradeModal} searchId={searchId} setorId={setorId} paywallApplied={paywallApplied} totalBeforePaywall={totalBeforePaywall} sectorName={sectorName} />
	          <ResultsList result={result} paginatedLicitacoes={paginatedLicitacoes} totalLicitacoes={totalLicitacoes} currentPage={currentPage} pageSize={pageSize} onPageChange={setCurrentPage} onPageSizeChange={setPageSize} searchMode={searchMode} termosArray={termosArray} planInfo={planInfo} session={session} onShowUpgradeModal={onShowUpgradeModal} searchId={searchId} setorId={setorId} paywallApplied={paywallApplied} totalBeforePaywall={totalBeforePaywall} sectorName={sectorName} />
	          <ResultsList result={result} paginatedLicitacoes={paginatedLicitacoes} totalLicitacoes={totalLicitacoes} currentPage={currentPage} pageSize={pageSize} onPageChange={setCurrentPage} onPageSizeChange={setPageSize} searchMode={searchMode} termosArray={termosArray} planInfo={planInfo} session={session} onShowUpgradeModal={onShowUpgradeModal} searchId={searchId} setorId={setorId} paywallApplied={paywallApplied} totalBeforePaywall={totalBeforePaywall} sectorName={sectorName} />
