...
async def submit_feedback(
    ...
    # FEEDBACK-002: Update user_sector_affinity based on feedback verdict
    # Graceful if table doesn't exist (migration not applied yet)
    try:
        ...
        await update_affinity(
            ...
            feedback_type=body.user_verdict.value,
        )
    except Exception:
        logger.debug("FEEDBACK-002: affinity update skipped (table may not exist yet)", exc_info=True)
