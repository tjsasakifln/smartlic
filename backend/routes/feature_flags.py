...
_FLAG_DESCRIPTIONS: dict[str, str] = {
    ...
    "COMMAND_API_ACCESS": "Command tier API access gate (fail-closed — 503 when off)",
    "COMMAND_MULTI_USER": "Command tier multi-user support gate (fail-closed — 503 when off)",
    "COMMAND_EXECUTIVE_REPORTS": "Command tier executive reports gate (fail-closed — 503 when off)",
}
...
_FLAG_LIFECYCLE: dict[str, dict] = {
    ...
    "COMMAND_API_ACCESS": {"owner": "product", "category": "command", "lifecycle": "gate", "created": "2026-06"},
    "COMMAND_MULTI_USER": {"owner": "product", "category": "command", "lifecycle": "gate", "created": "2026-06"},
    "COMMAND_EXECUTIVE_REPORTS": {"owner": "product", "category": "command", "lifecycle": "gate", "created": "2026-06"},
}
