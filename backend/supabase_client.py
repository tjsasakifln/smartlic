...
# POOL-001 (#1628): Increased from 10→20 per worker (40 total with 2 workers).
# Supabase free tier: 20 direct connections. Paid tiers: 60+ (Pro), 200+ (Team).
# When SUPABASE_POOL_MAX_CONNECTIONS > 10, ensure the Supabase project tier supports
# the total connection count (2 workers × per-worker pool).
