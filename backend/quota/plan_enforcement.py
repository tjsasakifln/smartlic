...
from quota.plan_auth import (  # noqa: F401 — re-exported for backward compat
    require_active_plan,
    ...
    requires_command_capability,  # Generic gate — accepts flag_name param
    requires_command_api_access,
    requires_command_multi_user,
    requires_command_executive_reports,
    get_command_api_access_dependency,
    get_command_multi_user_dependency,
    get_command_executive_reports_dependency,
)
